...
public class WEKA_GaussianNB_AtomlTest {
    ...
    public void test_UniformSplit() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            // create a csv file
            String filePath = "predictions/pred_WEKA_GaussianNB_UniformSplit_" + iter + ".csv";
            try {
            ...
            // create a csv file
            String filePathTrainingAsTest = "predictions/pred_WEKA_GaussianNB_UniformSplit_TrainingAsTest_" + iter + ".csv";
            try {
    ...
    public void test_RandomNumericSplit() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            ArrayList pred = eval.predictions();
            // create a csv file
            String filePath = "predictions/pred_WEKA_GaussianNB_RandomNumericSplit_" + iter + ".csv";
            try {
                File outFile = new File(filePath);
                outFile.createNewFile();
            } catch (IOException e) {
            ...
            ArrayList predTrainingAsTest = evalTrainingAsTest.predictions();
            // create a csv file
            String filePathTrainingAsTest = "predictions/pred_WEKA_GaussianNB_RandomNumericSplit_TrainingAsTest_" + iter + ".csv";
            try {
                File outFileTrainingAsTest = new File(filePathTrainingAsTest);
                outFileTrainingAsTest.createNewFile();
            } catch (IOException e) {
    ...
    public void test_BreastCancer() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            ArrayList pred = eval.predictions();
            // create a csv file
            String filePath = "predictions/pred_WEKA_GaussianNB_BreastCancer_" + iter + ".csv";
            try {
                File outFile = new File(filePath);
                outFile.createNewFile();
            } catch (IOException e) {
            ...
            ArrayList predTrainingAsTest = evalTrainingAsTest.predictions();
            // create a csv file
            String filePathTrainingAsTest = "predictions/pred_WEKA_GaussianNB_BreastCancer_TrainingAsTest_" + iter + ".csv";
            try {
                File outFileTrainingAsTest = new File(filePathTrainingAsTest);
                outFileTrainingAsTest.createNewFile();
            } catch (IOException e) {
    ...
    public void test_BreastCancerZNorm() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            ArrayList pred = eval.predictions();
            // create a csv file
            String filePath = "predictions/pred_WEKA_GaussianNB_BreastCancerZNorm_" + iter + ".csv";
            try {
                File outFile = new File(filePath);
                outFile.createNewFile();
            } catch (IOException e) {
            ...
            ArrayList predTrainingAsTest = evalTrainingAsTest.predictions();
            // create a csv file
            String filePathTrainingAsTest = "predictions/pred_WEKA_GaussianNB_BreastCancerZNorm_TrainingAsTest_" + iter + ".csv";
            try {
                File outFileTrainingAsTest = new File(filePathTrainingAsTest);
                outFileTrainingAsTest.createNewFile();
            } catch (IOException e) {
    ...
    public void test_BreastCancerMinMaxNorm() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            ArrayList pred = eval.predictions();
            // create a csv file
            String filePath = "predictions/pred_WEKA_GaussianNB_BreastCancerMinMaxNorm_" + iter + ".csv";
            try {
                File outFile = new File(filePath);
                outFile.createNewFile();
            } catch (IOException e) {
            ...
            ArrayList predTrainingAsTest = evalTrainingAsTest.predictions();
            // create a csv file
            String filePathTrainingAsTest = "predictions/pred_WEKA_GaussianNB_BreastCancerMinMaxNorm_TrainingAsTest_" + iter + ".csv";
            try {
                File outFileTrainingAsTest = new File(filePathTrainingAsTest);
                outFileTrainingAsTest.createNewFile();
            } catch (IOException e) {
    ...
    public void test_Wine() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            ArrayList pred = eval.predictions();
            // create a csv file
            String filePath = "predictions/pred_WEKA_GaussianNB_Wine_" + iter + ".csv";
            try {
                File outFile = new File(filePath);
                outFile.createNewFile();
            } catch (IOException e) {
            ...
            ArrayList predTrainingAsTest = evalTrainingAsTest.predictions();
            // create a csv file
            String filePathTrainingAsTest = "predictions/pred_WEKA_GaussianNB_Wine_TrainingAsTest_" + iter + ".csv";
            try {
                File outFileTrainingAsTest = new File(filePathTrainingAsTest);
                outFileTrainingAsTest.createNewFile();
            } catch (IOException e) {
    ...
    public void test_WineZNorm() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            ArrayList pred = eval.predictions();
            // create a csv file
            String filePath = "predictions/pred_WEKA_GaussianNB_WineZNorm_" + iter + ".csv";
            try {
                File outFile = new File(filePath);
                outFile.createNewFile();
            } catch (IOException e) {
            ...
            ArrayList predTrainingAsTest = evalTrainingAsTest.predictions();
            // create a csv file
            String filePathTrainingAsTest = "predictions/pred_WEKA_GaussianNB_WineZNorm_TrainingAsTest_" + iter + ".csv";
            try {
                File outFileTrainingAsTest = new File(filePathTrainingAsTest);
                outFileTrainingAsTest.createNewFile();
            } catch (IOException e) {
    ...
    public void test_WineMinMaxNorm() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            ArrayList pred = eval.predictions();
            // create a csv file
            String filePath = "predictions/pred_WEKA_GaussianNB_WineMinMaxNorm_" + iter + ".csv";
            try {
                File outFile = new File(filePath);
                outFile.createNewFile();
            } catch (IOException e) {
            ...
            ArrayList predTrainingAsTest = evalTrainingAsTest.predictions();
            // create a csv file
            String filePathTrainingAsTest = "predictions/pred_WEKA_GaussianNB_WineMinMaxNorm_TrainingAsTest_" + iter + ".csv";
            try {
                File outFileTrainingAsTest = new File(filePathTrainingAsTest);
                outFileTrainingAsTest.createNewFile();
            } catch (IOException e) {
